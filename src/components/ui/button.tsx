...
const RAISED_3D =
  'shadow-[inset_0_1px_0_0_rgba(255,255,255,0.25),inset_0_-1px_0_0_rgba(0,0,0,0.15),0_4px_0_0_rgba(0,0,0,0.35),0_6px_10px_-4px_rgba(0,0,0,0.35)] ' +
  'hover:brightness-105 ' +
  'active:translate-y-[4px] active:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.15),inset_0_-1px_0_0_rgba(0,0,0,0.15)] ' +

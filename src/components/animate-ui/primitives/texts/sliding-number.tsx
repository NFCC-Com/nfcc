...
import type {MotionValue, SpringOptions, HTMLMotionProps} from 'motion/react';
...
import type {UseIsInViewOptions} from '#/hooks/use-is-in-view.tsx';
...
function SlidingNumber({
  ...
  const formatNumber = React.useCallback(
    (num: number) =>
      decimalPlaces > 0 ? num.toFixed(decimalPlaces) : num.toString(),
    [decimalPlaces],
  );
